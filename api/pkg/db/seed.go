...
const seedVersion = "2026-02-13-v13"
...
DECLARE
    ...
    tables_to_clean TEXT[] := ARRAY[
        ...
        'player_games','player_services','player_schedules','player_skill_tags',
...
END $$;`
		...
		orderSpecs := []seedOrderSpec{
			...
			// Completed orders used for review moderation / reporting demos (must have payments)
			{
				Key:         "orderCompletedReviewPending1",
				UserKey:     "customerB",
				PlayerKey:   "playerA",
				GameKey:     "dota2",
				ItemCode:    "escort-dota2-solo",
				Title:       "战术指导复盘（待审核评价演示）",
				Description: "演示数据：订单已完成，评价待审核。",
				Status:      model.OrderStatusCompleted,
				PriceCents:  29900,
				Currency:    model.CurrencyCNY,
				StartOffset: -10 * hour,
			...
			{
				Key:         "orderCompletedReviewPending2",
				UserKey:     "customerG",
				PlayerKey:   "playerE",
				GameKey:     "fifa",
				ItemCode:    "escort-default",
				Title:       "FIFA 进阶技巧（待审核评价演示）",
				Description: "演示数据：订单已完成，评价待审核。",
				Status:      model.OrderStatusCompleted,
				PriceCents:  7900,
				Currency:    model.CurrencyCNY,
			...
			{
				Key:         "orderCompletedReviewPending3",
				UserKey:     "customerB",
				PlayerKey:   "playerG",
				GameKey:     "dota2",
				ItemCode:    "escort-dota2-solo",
				Title:       "DOTA2 新手教学（待审核评价演示）",
				Description: "演示数据：订单已完成，评价待审核。",
				Status:      model.OrderStatusCompleted,
				PriceCents:  21900,
				Currency:    model.CurrencyCNY,
			...
			{
				Key:         "orderCompletedReviewRejected1",
				UserKey:     "customerA",
				PlayerKey:   "playerB",
				GameKey:     "overwatch",
				ItemCode:    "escort-default",
				Title:       "守望先锋团队竞技（评价被拒绝演示）",
				Description: "演示数据：订单已完成，评价内容不符合规范被拒绝。",
				Status:      model.OrderStatusCompleted,
				PriceCents:  16900,
				Currency:    model.CurrencyCNY,
				StartOffset: -7 * hour,
			...
			{
				Key:         "orderCompletedReviewReported1",
				UserKey:     "customerD",
				PlayerKey:   "playerC",
				GameKey:     "csgo",
				ItemCode:    "escort-default",
				Title:       "枪法强化训练（评价被举报演示）",
				Description: "演示数据：订单已完成，评价被举报用于后台处理链路。",
				Status:      model.OrderStatusCompleted,
				PriceCents:  18900,
				Currency:    model.CurrencyCNY,
				StartOffset: -6 * hour,
			...
			{
				Key:         "orderCompletedReviewMedium1",
				UserKey:     "customerH",
				PlayerKey:   "playerF",
				GameKey:     "fallguys",
				ItemCode:    "escort-default",
				Title:       "糖豆人欢乐时光（中评演示）",
				Description: "演示数据：订单已完成，用于展示中等评价。",
				Status:      model.OrderStatusCompleted,
				PriceCents:  5900,
				Currency:    model.CurrencyCNY,
				StartOffset: -5 * hour,
			...
			{
				Key:         "orderCompletedReviewPendingImages1",
				UserKey:     "customerE",
				PlayerKey:   "playerB",
				GameKey:     "apex",
				ItemCode:    "escort-default",
				Title:       "大逃杀双人排位（带图评价演示）",
				Description: "演示数据：订单已完成，评价带图片。",
				Status:      model.OrderStatusCompleted,
				PriceCents:  9900,
				Currency:    model.CurrencyCNY,
				StartOffset: -4 * hour,
			...
			{
				Key:         "orderPendingE2E2",
				UserKey:     "customerE",
				PlayerKey:   "playerB",
				GameKey:     "valorant",
				ItemCode:    "escort-valorant-solo",
				Title:       "E2E测试-待取消订单2",
				Description: "E2E测试专用：用于测试批量取消功能。",
				Status:      model.OrderStatusPending,
				PriceCents:  12800,
				Currency:    model.CurrencyCNY,
				StartOffset: 4 * hour,
			...
			{
				Key:         "orderPendingE2E3",
				UserKey:     "customerF",
				PlayerKey:   "playerC",
				GameKey:     "csgo",
				ItemCode:    "escort-default",
				Title:       "E2E测试-待取消订单3",
				Description: "E2E测试专用：用于测试取消确认对话框。",
				Status:      model.OrderStatusPending,
				PriceCents:  15800,
				Currency:    model.CurrencyCNY,
				StartOffset: 5 * hour,
			...
			{
				Key:         "orderCompletedE2E2",
				UserKey:     "customerH",
				PlayerKey:   "playerE",
				GameKey:     "fifa",
				ItemCode:    "escort-default",
				Title:       "E2E测试-待退款订单2",
				Description: "E2E测试专用：用于测试退款原因填写。",
				Status:      model.OrderStatusCompleted,
				PriceCents:  9800,
				Currency:    model.CurrencyCNY,
				StartOffset: -10 * hour,
			...
			{
				Key:         "orderCompletedE2E3",
				UserKey:     "customerD",
				PlayerKey:   "playerF",
				GameKey:     "fallguys",
				ItemCode:    "escort-default",
				Title:       "E2E测试-待退款订单3",
				Description: "E2E测试专用：用于测试退款金额验证。",
				Status:      model.OrderStatusCompleted,
				PriceCents:  6800,
				Currency:    model.CurrencyCNY,
				StartOffset: -12 * hour,
		...
		paymentSpecs := []seedPaymentSpec{
			...
			// Payments for completed review demo orders
			{
				OrderKey:        "orderCompletedReviewPending1",
				UserKey:         "customerB",
				Method:          model.PaymentMethodAlipay,
				AmountCents:     29900,
				Currency:        model.CurrencyCNY,
				Status:          model.PaymentStatusPaid,
				ProviderTradeNo: "ALIREVIEWPEND001",
				ProviderRaw:     `{"result":"success","seed":"review_demo"}`,
				PaidAtOffset:    ptrDuration(-10 * hour),
			},
			{
				OrderKey:        "orderCompletedReviewPending2",
				UserKey:         "customerG",
				Method:          model.PaymentMethodWeChat,
				AmountCents:     7900,
				Currency:        model.CurrencyCNY,
				Status:          model.PaymentStatusPaid,
				ProviderTradeNo: "WXREVIEWPEND002",
				ProviderRaw:     `{"result":"success","seed":"review_demo"}`,
				PaidAtOffset:    ptrDuration(-9 * hour),
			},
			{
				OrderKey:        "orderCompletedReviewPending3",
				UserKey:         "customerB",
				Method:          model.PaymentMethodWeChat,
				AmountCents:     21900,
				Currency:        model.CurrencyCNY,
				Status:          model.PaymentStatusPaid,
				ProviderTradeNo: "WXREVIEWPEND003",
				ProviderRaw:     `{"result":"success","seed":"review_demo"}`,
				PaidAtOffset:    ptrDuration(-8 * hour),
			},
			{
				OrderKey:        "orderCompletedReviewRejected1",
				UserKey:         "customerA",
				Method:          model.PaymentMethodAlipay,
				AmountCents:     16900,
				Currency:        model.CurrencyCNY,
				Status:          model.PaymentStatusPaid,
				ProviderTradeNo: "ALIREVIEWREJ001",
				ProviderRaw:     `{"result":"success","seed":"review_demo"}`,
				PaidAtOffset:    ptrDuration(-7 * hour),
			},
			{
				OrderKey:        "orderCompletedReviewReported1",
				UserKey:         "customerD",
				Method:          model.PaymentMethodWeChat,
				AmountCents:     18900,
				Currency:        model.CurrencyCNY,
				Status:          model.PaymentStatusPaid,
				ProviderTradeNo: "WXREVIEWREPORT001",
				ProviderRaw:     `{"result":"success","seed":"review_demo"}`,
				PaidAtOffset:    ptrDuration(-6 * hour),
			},
			{
				OrderKey:        "orderCompletedReviewMedium1",
				UserKey:         "customerH",
				Method:          model.PaymentMethodWeChat,
				AmountCents:     5900,
				Currency:        model.CurrencyCNY,
				Status:          model.PaymentStatusPaid,
				ProviderTradeNo: "WXREVIEWMED001",
				ProviderRaw:     `{"result":"success","seed":"review_demo"}`,
				PaidAtOffset:    ptrDuration(-5 * hour),
			},
			{
				OrderKey:        "orderCompletedReviewPendingImages1",
				UserKey:         "customerE",
				Method:          model.PaymentMethodWeChat,
				AmountCents:     9900,
				Currency:        model.CurrencyCNY,
				Status:          model.PaymentStatusPaid,
				ProviderTradeNo: "WXREVIEWIMG001",
				ProviderRaw:     `{"result":"success","seed":"review_demo"}`,
				PaidAtOffset:    ptrDuration(-4 * hour),
			},
			{
			...
			// E2E 测试专用订单的支付记录 - 已完成订单需要支付记录才能退款
			{
				...
				Currency:        model.CurrencyCNY,
				Status:          model.PaymentStatusPaid,
				ProviderTradeNo: "WXE2EREFUND001",
				ProviderRaw:     `{"result":"success","e2e":"refund_test"}`,
				PaidAtOffset:    ptrDuration(-9 * hour),
			},
			{
				OrderKey:        "orderCompletedE2E2",
				UserKey:         "customerH",
				Method:          model.PaymentMethodAlipay,
				AmountCents:     9800,
				Currency:        model.CurrencyCNY,
				Status:          model.PaymentStatusPaid,
				ProviderTradeNo: "ALIE2EREFUND002",
				ProviderRaw:     `{"result":"success","e2e":"refund_test"}`,
				PaidAtOffset:    ptrDuration(-11 * hour),
			},
			{
				OrderKey:        "orderCompletedE2E3",
				UserKey:         "customerD",
				Method:          model.PaymentMethodWeChat,
				AmountCents:     6800,
				Currency:        model.CurrencyCNY,
				Status:          model.PaymentStatusPaid,
				ProviderTradeNo: "WXE2EREFUND003",
				ProviderRaw:     `{"result":"success","e2e":"refund_test"}`,
				PaidAtOffset:    ptrDuration(-13 * hour),
			},
		}
