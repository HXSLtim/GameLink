...
func (h *AdminTestHelper) RegisterRoutes() {
	...
	h.router.POST("/users/with-player", userHandler.CreateUserWithPlayer)
	h.router.POST("/users/batch-delete", userHandler.BatchDeleteUsers)
	h.router.GET("/users/:id", userHandler.GetUser)
	h.router.PUT("/users/:id", userHandler.UpdateUser)
	h.router.DELETE("/users/:id", userHandler.DeleteUser)
	h.router.PUT("/users/:id/status", userHandler.UpdateUserStatus)
	h.router.PUT("/users/:id/role", userHandler.UpdateUserRole)
