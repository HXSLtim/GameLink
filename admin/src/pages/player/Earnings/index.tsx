            ...
            <Row gutter={16} style={{ marginBottom: 16 }}>
                <Col xs={12} sm={6}>
                    <Card loading={loading}>
                        <Statistic title="今日收益" value={earningsInfo.todayEarnings} prefix={<RiseOutlined />} suffix="元" />
                    </Card>
                </Col>
                <Col xs={12} sm={6}>
                    <Card loading={loading}>
                        <Statistic title="本周收益" value={earningsInfo.weekEarnings} prefix={<CalendarOutlined />} suffix="元" />
                    </Card>
                </Col>
                <Col xs={12} sm={6}>
                    <Card loading={loading}>
                ...
                <Col xs={12} sm={6}>
                    <Card loading={loading}>
                        <Statistic title="累计收益" value={earningsInfo.totalEarnings} prefix={<DollarOutlined />} suffix="元" />
                    </Card>
                </Col>
            </Row>
