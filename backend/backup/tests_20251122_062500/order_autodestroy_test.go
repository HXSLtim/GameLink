...
func TestCancelOrder_AutoDeactivateOrderChat(t *testing.T) {
	...
	svc := NewOrderService(orderRepo, &mockPlayerRepository{}, &mockUserRepository{}, &mockGameRepository{}, &mockPaymentRepository{}, &mockReviewRepository{}, &mockCommissionRepository{}, &mockServiceItemRepository{})
