...
func (m *mockServiceItemRepository) List(ctx context.Context, opts serviceitem.ServiceItemListOptions) ([]model.ServiceItem, int64, error) {
	return []model.ServiceItem{}, 0, nil
}
...
// TestCancelOrder_EdgeCases 测试取消订单的边界条�?
