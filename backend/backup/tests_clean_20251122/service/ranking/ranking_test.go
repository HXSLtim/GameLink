...
func (f *fakeRankingRepo) CreateRanking(ctx context.Context, r *model.PlayerRanking) error {
...
func (f *fakeRankingRepo) UpdateRanking(ctx context.Context, r *model.PlayerRanking) error {
	return nil
}
func (f *fakeRankingRepo) CreateReward(ctx context.Context, reward *model.RankingReward) error {
	return nil
}
func (f *fakeRankingRepo) GetReward(ctx context.Context, id uint64) (*model.RankingReward, error) {
	return nil, repository.ErrNotFound
}
func (f *fakeRankingRepo) ListRewards(ctx context.Context, opts rankingrepo.RewardListOptions) ([]model.RankingReward, int64, error) {
	return nil, 0, nil
}
func (f *fakeRankingRepo) UpdateReward(ctx context.Context, reward *model.RankingReward) error {
	return nil
}
func (f *fakeRankingRepo) DeleteReward(ctx context.Context, id uint64) error { return nil }
func (f *fakeRankingRepo) GetRewardForRank(ctx context.Context, rt model.RankingType, period string, rank int) (*model.RankingReward, error) {
	return f.reward, nil
}
...
func (f *fakeOrderRepo) List(ctx context.Context, opts repository.OrderListOptions) ([]model.Order, int64, error) {
