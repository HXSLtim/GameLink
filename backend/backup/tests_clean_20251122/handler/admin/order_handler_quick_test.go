...
func (r *fakeOrderRepo2) Create(ctx context.Context, o *model.Order) error {
	r.m[o.ID] = o
	if o.ID == 0 {
		o.ID = 1
		r.m[o.ID] = o
...
func (r *fakeOrderRepo2) List(ctx context.Context, opts repository.OrderListOptions) ([]model.Order, int64, error) {
...
func (r *fakeOrderRepo2) Get(ctx context.Context, id uint64) (*model.Order, error) {
	v := r.m[id]
	if v == nil {
...
func newFakePaymentRepo2() *fakePaymentRepo2 {
	return &fakePaymentRepo2{m: map[uint64]*model.Payment{}}
}
func (r *fakePaymentRepo2) Create(ctx context.Context, p *model.Payment) error {
	if p.ID == 0 {
...
func (r *fakePaymentRepo2) List(ctx context.Context, opts repository.PaymentListOptions) ([]model.Payment, int64, error) {
	out := []model.Payment{}
	for _, v := range r.m {
...
func (r *fakePaymentRepo2) Get(ctx context.Context, id uint64) (*model.Payment, error) {
	v := r.m[id]
	if v == nil {
		return nil, repository.ErrNotFound
	}
...
func (r *fakePaymentRepo2) Update(ctx context.Context, p *model.Payment) error {
	r.m[p.ID] = p
	return nil
}
...
func (fakeUserRepo3) ListPaged(context.Context, int, int) ([]model.User, int64, error) {
	return nil, 0, nil
}
func (fakeUserRepo3) ListWithFilters(context.Context, repository.UserListOptions) ([]model.User, int64, error) {
	return nil, 0, nil
}
func (fakeUserRepo3) Get(context.Context, uint64) (*model.User, error) {
	return &model.User{Base: model.Base{ID: 1}, Name: "u", Role: model.RoleUser, Status: model.UserStatusActive}, nil
}
func (fakeUserRepo3) GetByPhone(context.Context, string) (*model.User, error) {
	return nil, repository.ErrNotFound
}
func (fakeUserRepo3) FindByEmail(context.Context, string) (*model.User, error) {
	return nil, repository.ErrNotFound
}
func (fakeUserRepo3) FindByPhone(context.Context, string) (*model.User, error) {
	return nil, repository.ErrNotFound
}
...
func (fakePlayerRepo3) ListPaged(context.Context, int, int) ([]model.Player, int64, error) {
	return nil, 0, nil
}
func (fakePlayerRepo3) Get(context.Context, uint64) (*model.Player, error) {
	return &model.Player{Base: model.Base{ID: 1}, UserID: 1, Nickname: "p"}, nil
}
func (fakePlayerRepo3) GetByUserID(context.Context, uint64) (*model.Player, error) {
	return &model.Player{Base: model.Base{ID: 1}, UserID: 1, Nickname: "p"}, nil
}
