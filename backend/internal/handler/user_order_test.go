...
func newFakeOrderRepository() *fakeOrderRepository { return &fakeOrderRepository{orders: make(map[uint64]*model.Order)} }
...
func (m *fakeOrderRepository) List(ctx context.Context, opts repository.OrderListOptions) ([]model.Order, int64, error) {
    ...
    var res []model.Order
    for _, o := range m.orders { res = append(res, *o) }
    return res, int64(len(res)), nil
}

func (m *fakeOrderRepository) Get(ctx context.Context, id uint64) (*model.Order, error) {
    if o, ok := m.orders[id]; ok { return o, nil }
    return nil, repository.ErrNotFound
}

func (m *fakeOrderRepository) Update(ctx context.Context, o *model.Order) error { m.orders[o.ID] = o; return nil }

func (m *fakeOrderRepository) Delete(ctx context.Context, id uint64) error { delete(m.orders, id); return nil }

type fakePlayerRepository struct{}

func (m *fakePlayerRepository) List(ctx context.Context) ([]model.Player, error) { return []model.Player{}, nil }
...
func (m *fakeUserRepository) List(ctx context.Context) ([]model.User, error) { return []model.User{}, nil }
func (m *fakeUserRepository) ListPaged(ctx context.Context, page, pageSize int) ([]model.User, int64, error) { return []model.User{}, 0, nil }
...
func (m *fakeUserRepository) GetByPhone(ctx context.Context, phone string) (*model.User, error) { return nil, nil }
func (m *fakeUserRepository) FindByEmail(ctx context.Context, email string) (*model.User, error) { return nil, nil }
func (m *fakeUserRepository) FindByPhone(ctx context.Context, phone string) (*model.User, error) { return nil, nil }
...
func (m *fakeGameRepository) List(ctx context.Context) ([]model.Game, error) { return []model.Game{}, nil }
func (m *fakeGameRepository) ListPaged(ctx context.Context, page, pageSize int) ([]model.Game, int64, error) { return []model.Game{}, 0, nil }
...
func (m *fakePaymentRepository) Get(ctx context.Context, id uint64) (*model.Payment, error) { return &model.Payment{}, nil }
...
func (m *fakeReviewRepository) Get(ctx context.Context, id uint64) (*model.Review, error) { return &model.Review{}, nil }
...
func setupOrderTestRouter(svc *order.OrderService, userID uint64) *gin.Engine {
    ...
    r := gin.New()
    RegisterUserOrderRoutes(r, svc, fakeAuthMiddleware(userID))
    return r
}
