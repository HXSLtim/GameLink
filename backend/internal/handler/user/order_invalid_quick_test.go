...
func newInvalidOrderRepo() *invalidOrderRepo {
	return &invalidOrderRepo{items: map[uint64]*model.Order{}}
}
func (r *invalidOrderRepo) Create(ctx context.Context, o *model.Order) error {
	r.items[o.ID] = o
	return nil
}
func (r *invalidOrderRepo) List(ctx context.Context, opts repository.OrderListOptions) ([]model.Order, int64, error) {
	out := []model.Order{}
...
func (r *invalidOrderRepo) Get(ctx context.Context, id uint64) (*model.Order, error) {
	v := r.items[id]
	if v == nil {
...
func (r *invalidOrderRepo) Update(ctx context.Context, o *model.Order) error {
	r.items[o.ID] = o
	return nil
}
func (r *invalidOrderRepo) Delete(ctx context.Context, id uint64) error {
	delete(r.items, id)
	return nil
}
...
func (invalidPlayers) ListPaged(context.Context, int, int) ([]model.Player, int64, error) {
	return []model.Player{{Base: model.Base{ID: 1}, UserID: 1, Nickname: "p", HourlyRateCents: 1000}}, 1, nil
}
func (invalidPlayers) Get(context.Context, uint64) (*model.Player, error) {
	return &model.Player{Base: model.Base{ID: 1}, UserID: 1, Nickname: "p", HourlyRateCents: 1000}, nil
}
func (invalidPlayers) GetByUserID(context.Context, uint64) (*model.Player, error) {
	return &model.Player{Base: model.Base{ID: 1}, UserID: 1, Nickname: "p", HourlyRateCents: 1000}, nil
}
...
func (invalidUsers) ListPaged(context.Context, int, int) ([]model.User, int64, error) {
	return nil, 0, nil
}
func (invalidUsers) ListWithFilters(context.Context, repository.UserListOptions) ([]model.User, int64, error) {
	return nil, 0, nil
}
func (invalidUsers) Get(context.Context, uint64) (*model.User, error) {
	return &model.User{Base: model.Base{ID: 1}, AvatarURL: "a"}, nil
}
func (invalidUsers) GetByPhone(context.Context, string) (*model.User, error) {
	return nil, repository.ErrNotFound
}
func (invalidUsers) FindByEmail(context.Context, string) (*model.User, error) {
	return nil, repository.ErrNotFound
}
func (invalidUsers) FindByPhone(context.Context, string) (*model.User, error) {
	return nil, repository.ErrNotFound
}
...
func (invalidGames) ListPaged(context.Context, int, int) ([]model.Game, int64, error) {
	return nil, 0, nil
}
func (invalidGames) Get(context.Context, uint64) (*model.Game, error) {
...
func (invalidPayments) List(context.Context, repository.PaymentListOptions) ([]model.Payment, int64, error) {
	return nil, 0, nil
}
func (invalidPayments) Get(context.Context, uint64) (*model.Payment, error) {
	return nil, repository.ErrNotFound
}
...
func (invalidReviews) List(context.Context, repository.ReviewListOptions) ([]model.Review, int64, error) {
	return nil, 0, nil
}
func (invalidReviews) Get(context.Context, uint64) (*model.Review, error) {
	return nil, repository.ErrNotFound
}
...
func (invalidCommissions) GetRule(context.Context, uint64) (*model.CommissionRule, error) {
	return nil, repository.ErrNotFound
}
func (invalidCommissions) GetDefaultRule(context.Context) (*model.CommissionRule, error) {
	return &model.CommissionRule{Rate: 20}, nil
}
func (invalidCommissions) GetRuleForOrder(context.Context, *uint64, *uint64, *string) (*model.CommissionRule, error) {
	return nil, repository.ErrNotFound
}
func (invalidCommissions) ListRules(context.Context, commissionrepo.CommissionRuleListOptions) ([]model.CommissionRule, int64, error) {
	return nil, 0, nil
}
...
func (invalidCommissions) GetRecord(context.Context, uint64) (*model.CommissionRecord, error) {
	return nil, repository.ErrNotFound
}
func (invalidCommissions) GetRecordByOrderID(context.Context, uint64) (*model.CommissionRecord, error) {
	return nil, repository.ErrNotFound
}
func (invalidCommissions) ListRecords(context.Context, commissionrepo.CommissionRecordListOptions) ([]model.CommissionRecord, int64, error) {
	return nil, 0, nil
}
func (invalidCommissions) UpdateRecord(context.Context, *model.CommissionRecord) error { return nil }
func (invalidCommissions) CreateSettlement(context.Context, *model.MonthlySettlement) error {
	return nil
}
func (invalidCommissions) GetSettlement(context.Context, uint64) (*model.MonthlySettlement, error) {
	return nil, repository.ErrNotFound
}
func (invalidCommissions) GetSettlementByPlayerMonth(context.Context, uint64, string) (*model.MonthlySettlement, error) {
	return nil, repository.ErrNotFound
}
func (invalidCommissions) ListSettlements(context.Context, commissionrepo.SettlementListOptions) ([]model.MonthlySettlement, int64, error) {
	return nil, 0, nil
}
func (invalidCommissions) UpdateSettlement(context.Context, *model.MonthlySettlement) error {
	return nil
}
func (invalidCommissions) GetMonthlyStats(context.Context, string) (*commissionrepo.MonthlyStats, error) {
	return &commissionrepo.MonthlyStats{}, nil
}
func (invalidCommissions) GetPlayerMonthlyIncome(context.Context, uint64, string) (int64, error) {
	return 0, nil
}
...
func setupOrderInvalidRouter(repo *invalidOrderRepo) *gin.Engine {
	...
	assignSvc := newAssignmentServiceStub(repo, invalidPlayers{})
