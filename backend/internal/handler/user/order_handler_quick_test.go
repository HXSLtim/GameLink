...
type fakeOrderRepo struct {
	items map[uint64]*model.Order
	next  uint64
}

func newFakeOrderRepo() *fakeOrderRepo {
	return &fakeOrderRepo{items: map[uint64]*model.Order{}, next: 1}
}
...
func (f *fakeOrderRepo) List(ctx context.Context, _ repository.OrderListOptions) ([]model.Order, int64, error) {
	out := make([]model.Order, 0, len(f.items))
...
func (f *fakeOrderRepo) Update(ctx context.Context, o *model.Order) error {
	f.items[o.ID] = o
	return nil
}
...
func (fakePlayerRepoOrd) ListPaged(context.Context, int, int) ([]model.Player, int64, error) {
	return []model.Player{{Base: model.Base{ID: 1}, UserID: 1, Nickname: "p", HourlyRateCents: 1000}}, 1, nil
}
func (fakePlayerRepoOrd) Get(context.Context, uint64) (*model.Player, error) {
	return &model.Player{Base: model.Base{ID: 1}, UserID: 1, Nickname: "p", HourlyRateCents: 1000}, nil
}
func (fakePlayerRepoOrd) GetByUserID(context.Context, uint64) (*model.Player, error) {
	return &model.Player{Base: model.Base{ID: 1}, UserID: 1, Nickname: "p", HourlyRateCents: 1000}, nil
}
...
func (fakeUserRepoOrd) ListPaged(context.Context, int, int) ([]model.User, int64, error) {
	return nil, 0, nil
}
func (fakeUserRepoOrd) ListWithFilters(context.Context, repository.UserListOptions) ([]model.User, int64, error) {
	return nil, 0, nil
}
func (fakeUserRepoOrd) Get(context.Context, uint64) (*model.User, error) {
	return &model.User{Base: model.Base{ID: 1}, AvatarURL: "a"}, nil
}
func (fakeUserRepoOrd) GetByPhone(context.Context, string) (*model.User, error) {
	return nil, repository.ErrNotFound
}
func (fakeUserRepoOrd) FindByEmail(context.Context, string) (*model.User, error) {
	return nil, repository.ErrNotFound
}
func (fakeUserRepoOrd) FindByPhone(context.Context, string) (*model.User, error) {
	return nil, repository.ErrNotFound
}
...
func (fakeGameRepoOrd) ListPaged(context.Context, int, int) ([]model.Game, int64, error) {
	return nil, 0, nil
}
func (fakeGameRepoOrd) Get(context.Context, uint64) (*model.Game, error) {
...
func (f *fakePaymentRepoOrd) List(context.Context, repository.PaymentListOptions) ([]model.Payment, int64, error) {
	out := make([]model.Payment, 0, len(f.items))
	for _, v := range f.items {
		out = append(out, v)
	}
	return out, int64(len(out)), nil
}
func (f *fakePaymentRepoOrd) Get(context.Context, uint64) (*model.Payment, error) {
	return nil, repository.ErrNotFound
}
...
func (fakeReviewRepoOrd) List(context.Context, repository.ReviewListOptions) ([]model.Review, int64, error) {
	return nil, 0, nil
}
func (fakeReviewRepoOrd) Get(context.Context, uint64) (*model.Review, error) {
	return nil, repository.ErrNotFound
}
...
func (fakeCommissionRepoOrd) GetRule(context.Context, uint64) (*model.CommissionRule, error) {
	return nil, repository.ErrNotFound
}
func (fakeCommissionRepoOrd) GetDefaultRule(context.Context) (*model.CommissionRule, error) {
	return &model.CommissionRule{Rate: 20}, nil
}
func (fakeCommissionRepoOrd) GetRuleForOrder(context.Context, *uint64, *uint64, *string) (*model.CommissionRule, error) {
	return nil, repository.ErrNotFound
}
func (fakeCommissionRepoOrd) ListRules(context.Context, commissionrepo.CommissionRuleListOptions) ([]model.CommissionRule, int64, error) {
	return nil, 0, nil
}
...
func (fakeCommissionRepoOrd) GetRecord(context.Context, uint64) (*model.CommissionRecord, error) {
	return nil, repository.ErrNotFound
}
func (fakeCommissionRepoOrd) GetRecordByOrderID(context.Context, uint64) (*model.CommissionRecord, error) {
	return nil, repository.ErrNotFound
}
func (fakeCommissionRepoOrd) ListRecords(context.Context, commissionrepo.CommissionRecordListOptions) ([]model.CommissionRecord, int64, error) {
	return nil, 0, nil
}
func (fakeCommissionRepoOrd) UpdateRecord(context.Context, *model.CommissionRecord) error { return nil }
func (fakeCommissionRepoOrd) CreateSettlement(context.Context, *model.MonthlySettlement) error {
	return nil
}
func (fakeCommissionRepoOrd) GetSettlement(context.Context, uint64) (*model.MonthlySettlement, error) {
	return nil, repository.ErrNotFound
}
func (fakeCommissionRepoOrd) GetSettlementByPlayerMonth(context.Context, uint64, string) (*model.MonthlySettlement, error) {
	return nil, repository.ErrNotFound
}
func (fakeCommissionRepoOrd) ListSettlements(context.Context, commissionrepo.SettlementListOptions) ([]model.MonthlySettlement, int64, error) {
	return nil, 0, nil
}
func (fakeCommissionRepoOrd) UpdateSettlement(context.Context, *model.MonthlySettlement) error {
	return nil
}
func (fakeCommissionRepoOrd) GetMonthlyStats(context.Context, string) (*commissionrepo.MonthlyStats, error) {
	return &commissionrepo.MonthlyStats{}, nil
}
func (fakeCommissionRepoOrd) GetPlayerMonthlyIncome(context.Context, uint64, string) (int64, error) {
	return 0, nil
}
...
func setupUserOrderRouter(repo *fakeOrderRepo) *gin.Engine {
	...
	assignSvc := newAssignmentServiceStub(repo, fakePlayerRepoOrd{})
