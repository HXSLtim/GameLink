...
func newFakePaymentRepo() *fakePaymentRepo {
	return &fakePaymentRepo{items: map[uint64]*model.Payment{}, next: 1}
}
...
func (f *fakePaymentRepo) Delete(ctx context.Context, id uint64) error {
	delete(f.items, id)
	return nil
}
...
func (f *fakeOrderRepoPay) Create(ctx context.Context, o *model.Order) error {
	_ = ctx
	_ = o
	return nil
}
func (f *fakeOrderRepoPay) List(ctx context.Context, opts repository.OrderListOptions) ([]model.Order, int64, error) {
	_ = ctx
	_ = opts
	return nil, 0, nil
}
func (f *fakeOrderRepoPay) Get(ctx context.Context, id uint64) (*model.Order, error) {
	_ = ctx
	o := f.items[id]
	if o == nil {
		return nil, repository.ErrNotFound
...
func (f *fakeOrderRepoPay) Update(ctx context.Context, o *model.Order) error {
	_ = ctx
	f.items[o.ID] = o
	return nil
}
