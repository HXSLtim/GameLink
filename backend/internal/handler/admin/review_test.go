...
func (o opLogsCSV) ListByEntity(context.Context, string, uint64, repository.OperationLogListOptions) ([]model.OperationLog, int64, error) {
	return o.items, int64(len(o.items)), nil
}

type txLogs struct{ repos common.Repos }

func (t *txLogs) WithTx(ctx context.Context, fn func(r *common.Repos) error) error {
	return fn(&t.repos)
}
...
func (r *reviewsRepo) List(context.Context, repository.ReviewListOptions) ([]model.Review, int64, error) {
	return nil, 0, nil
}
func (r *reviewsRepo) Get(context.Context, uint64) (*model.Review, error) {
	return &model.Review{Base: model.Base{ID: 1}, Score: 5}, nil
}
func (r *reviewsRepo) Create(ctx context.Context, rv *model.Review) error {
	r.created = rv
	rv.ID = 10
	return nil
}
...
func (t *txReviews) WithTx(ctx context.Context, fn func(r *common.Repos) error) error {
	return fn(&t.repos)
}
