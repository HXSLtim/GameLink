...
func (f *routerPermRepo) ListPaged(_ context.Context, _ int, _ int) ([]model.Permission, int64, error) { return nil, 0, nil }
func (f *routerPermRepo) ListPagedWithFilter(_ context.Context, _ int, _ int, _, _, _ string) ([]model.Permission, int64, error) { return nil, 0, nil }
func (f *routerPermRepo) ListByGroup(_ context.Context) (map[string][]model.Permission, error) { return nil, nil }
func (f *routerPermRepo) ListGroups(_ context.Context) ([]string, error) { return nil, nil }
func (f *routerPermRepo) Get(_ context.Context, _ uint64) (*model.Permission, error) { return nil, repository.ErrNotFound }
func (f *routerPermRepo) GetByResource(_ context.Context, _, _ string) (*model.Permission, error) { return nil, repository.ErrNotFound }
func (f *routerPermRepo) GetByCode(_ context.Context, _ string) (*model.Permission, error) { return nil, repository.ErrNotFound }
func (f *routerPermRepo) GetByMethodAndPath(_ context.Context, _, _ string) (*model.Permission, error) { return nil, repository.ErrNotFound }
...
func (f *routerPermRepo) ListByRoleID(_ context.Context, _ uint64) ([]model.Permission, error) { return nil, nil }
func (f *routerPermRepo) ListByUserID(_ context.Context, uid uint64) ([]model.Permission, error) { return f.byUser[uid], nil }

type routerRoleRepo struct{}
func (routerRoleRepo) List(_ context.Context) ([]model.RoleModel, error) { return nil, nil }
func (routerRoleRepo) ListPaged(_ context.Context, _ int, _ int) ([]model.RoleModel, int64, error) { return nil, 0, nil }
func (routerRoleRepo) ListPagedWithFilter(_ context.Context, _ int, _ int, _ string, _ *bool) ([]model.RoleModel, int64, error) { return nil, 0, nil }
func (routerRoleRepo) ListWithPermissions(_ context.Context) ([]model.RoleModel, error) { return nil, nil }
func (routerRoleRepo) Get(_ context.Context, _ uint64) (*model.RoleModel, error) { return nil, repository.ErrNotFound }
func (routerRoleRepo) GetWithPermissions(_ context.Context, _ uint64) (*model.RoleModel, error) { return nil, repository.ErrNotFound }
func (routerRoleRepo) GetBySlug(_ context.Context, _ string) (*model.RoleModel, error) { return nil, repository.ErrNotFound }
...
func (routerRoleRepo) ListByUserID(_ context.Context, _ uint64) ([]model.RoleModel, error) { return nil, nil }
func (routerRoleRepo) CheckUserHasRole(_ context.Context, _ uint64, _ string) (bool, error) { return false, nil }

type routerGameRepo struct{}
func (routerGameRepo) List(_ context.Context) ([]model.Game, error) { return nil, nil }
func (routerGameRepo) ListPaged(_ context.Context, _ int, _ int) ([]model.Game, int64, error) { return []model.Game{}, 0, nil }
func (routerGameRepo) Get(_ context.Context, _ uint64) (*model.Game, error) { return nil, repository.ErrNotFound }
...
func (routerUsers) ListPaged(_ context.Context, _ int, _ int) ([]model.User, int64, error) { return nil, 0, nil }
func (routerUsers) ListWithFilters(_ context.Context, _ repository.UserListOptions) ([]model.User, int64, error) { return nil, 0, nil }
func (routerUsers) Get(_ context.Context, _ uint64) (*model.User, error) { return nil, repository.ErrNotFound }
func (routerUsers) GetByPhone(_ context.Context, _ string) (*model.User, error) { return nil, repository.ErrNotFound }
func (routerUsers) FindByEmail(_ context.Context, _ string) (*model.User, error) { return nil, repository.ErrNotFound }
func (routerUsers) FindByPhone(_ context.Context, _ string) (*model.User, error) { return nil, repository.ErrNotFound }
...
func (routerPlayers) ListPaged(_ context.Context, _ int, _ int) ([]model.Player, int64, error) { return nil, 0, nil }
func (routerPlayers) Get(_ context.Context, _ uint64) (*model.Player, error) { return nil, repository.ErrNotFound }
...
func (routerOrders) List(_ context.Context, _ repository.OrderListOptions) ([]model.Order, int64, error) { return nil, 0, nil }
func (routerOrders) Get(_ context.Context, _ uint64) (*model.Order, error) { return nil, repository.ErrNotFound }
...
func (routerPayments) List(_ context.Context, _ repository.PaymentListOptions) ([]model.Payment, int64, error) { return nil, 0, nil }
func (routerPayments) Get(_ context.Context, _ uint64) (*model.Payment, error) { return nil, repository.ErrNotFound }
...
func TestAdminRouter_AuthAndPermission(t *testing.T) {
    ...
    r.ServeHTTP(w1, req1)
    if w1.Code != http.StatusUnauthorized { t.Fatalf("expected 401, got %d", w1.Code) }
    ...
    if w3.Code != http.StatusOK && w3.Code != http.StatusInternalServerError { t.Fatalf("expected 200/500, got %d", w3.Code) }
    ...
    if w4.Code != http.StatusForbidden { t.Fatalf("expected 403, got %d", w4.Code) }
    ...
    if w5.Code != http.StatusOK && w5.Code != http.StatusInternalServerError { t.Fatalf("expected 200/500, got %d", w5.Code) }
    ...
    if w6.Code != http.StatusForbidden { t.Fatalf("expected 403, got %d", w6.Code) }
    ...
    if w7.Code != http.StatusOK && w7.Code != http.StatusInternalServerError { t.Fatalf("expected 200/500, got %d", w7.Code) }
    ...
    if w8.Code != http.StatusForbidden { t.Fatalf("expected 403, got %d", w8.Code) }
    ...
    if w9.Code != http.StatusOK && w9.Code != http.StatusInternalServerError { t.Fatalf("expected 200/500, got %d", w9.Code) }
    ...
    if w10.Code != http.StatusOK && w10.Code != http.StatusInternalServerError && w10.Code != http.StatusNotFound { t.Fatalf("expected 200/404/500, got %d", w10.Code) }
    ...
    if w11.Code != http.StatusForbidden && w11.Code != http.StatusInternalServerError && w11.Code != http.StatusNotFound { t.Fatalf("expected 403/404/500, got %d", w11.Code) }
    ...
    if w12.Code != http.StatusOK && w12.Code != http.StatusInternalServerError && w12.Code != http.StatusNotFound { t.Fatalf("expected 200/404/500, got %d", w12.Code) }
    ...
    if w13.Code != http.StatusForbidden && w13.Code != http.StatusInternalServerError && w13.Code != http.StatusNotFound { t.Fatalf("expected 403/404/500, got %d", w13.Code) }
    ...
    if w14.Code != http.StatusOK && w14.Code != http.StatusInternalServerError && w14.Code != http.StatusNotFound { t.Fatalf("expected 200/404/500, got %d", w14.Code) }
    ...
    if w15.Code != http.StatusForbidden && w15.Code != http.StatusInternalServerError && w15.Code != http.StatusNotFound { t.Fatalf("expected 403/404/500, got %d", w15.Code) }
    ...
    if w16.Code != http.StatusOK && w16.Code != http.StatusInternalServerError && w16.Code != http.StatusNotFound { t.Fatalf("expected 200/404/500, got %d", w16.Code) }
    ...
    if w17.Code != http.StatusForbidden && w17.Code != http.StatusInternalServerError && w17.Code != http.StatusNotFound { t.Fatalf("expected 403/404/500, got %d", w17.Code) }
    ...
    if w18.Code != http.StatusOK && w18.Code != http.StatusInternalServerError && w18.Code != http.StatusNotFound { t.Fatalf("expected 200/404/500, got %d", w18.Code) }
    ...
    if w19.Code != http.StatusForbidden && w19.Code != http.StatusInternalServerError && w19.Code != http.StatusNotFound { t.Fatalf("expected 403/404/500, got %d", w19.Code) }
    ...
    if w20.Code != http.StatusOK && w20.Code != http.StatusInternalServerError && w20.Code != http.StatusNotFound { t.Fatalf("expected 200/404/500, got %d", w20.Code) }
    ...
    if w21.Code != http.StatusForbidden && w21.Code != http.StatusInternalServerError && w21.Code != http.StatusNotFound { t.Fatalf("expected 403/404/500, got %d", w21.Code) }
    ...
    if w22.Code != http.StatusOK && w22.Code != http.StatusInternalServerError && w22.Code != http.StatusNotFound { t.Fatalf("expected 200/404/500, got %d", w22.Code) }
    ...
    if w23.Code != http.StatusForbidden && w23.Code != http.StatusInternalServerError && w23.Code != http.StatusNotFound { t.Fatalf("expected 403/404/500, got %d", w23.Code) }
    ...
    if w24.Code != http.StatusOK && w24.Code != http.StatusInternalServerError && w24.Code != http.StatusNotFound { t.Fatalf("expected 200/404/500, got %d", w24.Code) }
    ...
    if w25.Code != http.StatusForbidden && w25.Code != http.StatusInternalServerError && w25.Code != http.StatusNotFound { t.Fatalf("expected 403/404/500, got %d", w25.Code) }
    ...
    if w26.Code != http.StatusOK && w26.Code != http.StatusInternalServerError && w26.Code != http.StatusNotFound { t.Fatalf("expected 200/404/500, got %d", w26.Code) }
    ...
    if w27.Code != http.StatusForbidden && w27.Code != http.StatusInternalServerError && w27.Code != http.StatusNotFound { t.Fatalf("expected 403/404/500, got %d", w27.Code) }
    ...
    if w28.Code != http.StatusOK && w28.Code != http.StatusInternalServerError && w28.Code != http.StatusNotFound { t.Fatalf("expected 200/404/500, got %d", w28.Code) }
}
