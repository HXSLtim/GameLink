...
func (permRepoStub) ListPaged(context.Context, int, int) ([]model.Permission, int64, error) {
	return nil, 0, nil
}
func (permRepoStub) ListPagedWithFilter(context.Context, int, int, string, string, string) ([]model.Permission, int64, error) {
	return nil, 0, nil
}
func (permRepoStub) ListByGroup(context.Context) (map[string][]model.Permission, error) {
	return nil, nil
}
func (permRepoStub) ListGroups(context.Context) ([]string, error) { return nil, nil }
func (permRepoStub) Get(context.Context, uint64) (*model.Permission, error) {
	return nil, repository.ErrNotFound
}
func (permRepoStub) GetByResource(context.Context, string, string) (*model.Permission, error) {
	return nil, repository.ErrNotFound
}
func (permRepoStub) GetByCode(context.Context, string) (*model.Permission, error) {
	return nil, repository.ErrNotFound
}
func (permRepoStub) GetByMethodAndPath(context.Context, string, string) (*model.Permission, error) {
	return nil, repository.ErrNotFound
}
...
func (permRepoStub) ListByRoleID(context.Context, uint64) ([]model.Permission, error) {
	return nil, nil
}
...
func (roleRepoStub) ListPaged(context.Context, int, int) ([]model.RoleModel, int64, error) {
	return nil, 0, nil
}
func (roleRepoStub) ListPagedWithFilter(context.Context, int, int, string, *bool) ([]model.RoleModel, int64, error) {
	return nil, 0, nil
}
func (roleRepoStub) ListWithPermissions(context.Context) ([]model.RoleModel, error) { return nil, nil }
func (roleRepoStub) Get(context.Context, uint64) (*model.RoleModel, error) {
	return nil, repository.ErrNotFound
}
func (roleRepoStub) GetWithPermissions(context.Context, uint64) (*model.RoleModel, error) {
	return nil, repository.ErrNotFound
}
func (roleRepoStub) GetBySlug(context.Context, string) (*model.RoleModel, error) {
	return nil, repository.ErrNotFound
}
...
func (statsRepoStub) Dashboard(ctx context.Context) (repository.Dashboard, error) {
	return repository.Dashboard{}, nil
}
func (statsRepoStub) RevenueTrend(ctx context.Context, days int) ([]repository.DateValue, error) {
	return []repository.DateValue{{Date: "2025-01-01", Value: int64(days)}}, nil
}
func (statsRepoStub) UserGrowth(ctx context.Context, days int) ([]repository.DateValue, error) {
	return []repository.DateValue{{Date: "2025-01-01", Value: int64(days)}}, nil
}
func (statsRepoStub) OrdersByStatus(ctx context.Context) (map[string]int64, error) {
	return map[string]int64{"pending": 1}, nil
}
func (statsRepoStub) TopPlayers(ctx context.Context, limit int) ([]repository.PlayerTop, error) {
	return []repository.PlayerTop{{PlayerID: 1, Nickname: "p"}}, nil
}
func (statsRepoStub) AuditOverview(ctx context.Context, from *time.Time, to *time.Time) (map[string]int64, map[string]int64, error) {
	return map[string]int64{"order": 1}, map[string]int64{"create": 1}, nil
}
func (statsRepoStub) AuditTrend(ctx context.Context, from *time.Time, to *time.Time, entity string, action string) ([]repository.DateValue, error) {
