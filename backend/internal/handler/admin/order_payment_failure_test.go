...
func (r *failOrderRepo) List(context.Context, repository.OrderListOptions) ([]model.Order, int64, error) {
	return nil, 0, nil
}
func (r *failOrderRepo) Get(context.Context, uint64) (*model.Order, error) {
	return &model.Order{Base: model.Base{ID: 1}, Status: model.OrderStatusPending}, nil
}
...
func (failPayRepo) List(context.Context, repository.PaymentListOptions) ([]model.Payment, int64, error) {
	return nil, 0, nil
}
func (failPayRepo) Get(context.Context, uint64) (*model.Payment, error) {
	return &model.Payment{Base: model.Base{ID: 1}, Status: model.PaymentStatusPaid}, nil
}
