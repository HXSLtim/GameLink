...
// RegisterUserPlayerRoutes 注册用户端陪玩师路由
func RegisterUserPlayerRoutes(router gin.IRouter, svc *player.PlayerService, authMiddleware gin.HandlerFunc) {
...
// @Param        onlineOnly  query     bool    false  "仅在线"
