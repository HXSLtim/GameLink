...
func RegisterRoutes(router gin.IRouter, svc *service.AdminService) {
	...
	}
	{
        ...
        group.POST("/orders/:id/confirm", orderHandler.ConfirmOrder)
        group.POST("/orders/:id/start", orderHandler.StartOrder)
        group.POST("/orders/:id/complete", orderHandler.CompleteOrder)
        group.POST("/orders/:id/refund", orderHandler.RefundOrder)
        group.GET("/orders/:id/logs", orderHandler.ListOrderLogs)
        group.GET("/orders/:id/timeline", orderHandler.GetOrderTimeline)
        group.GET("/orders/:id/payments", orderHandler.ListOrderPayments)
        group.GET("/orders/:id/refunds", orderHandler.ListOrderRefunds)
        group.GET("/orders/:id/reviews", orderHandler.ListOrderReviews)
