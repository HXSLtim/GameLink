...
func (r *fakeGroupRepo) Get(ctx context.Context, id uint64) (*model.ChatGroup, error) {
	return nil, repository.ErrNotFound
}
func (r *fakeGroupRepo) GetByRelatedOrderID(ctx context.Context, orderID uint64) (*model.ChatGroup, error) {
	return nil, repository.ErrNotFound
}
func (r *fakeGroupRepo) ListByUser(ctx context.Context, userID uint64, opts repository.ChatGroupListOptions) ([]model.ChatGroup, int64, error) {
	return nil, 0, nil
}
func (r *fakeGroupRepo) ListMembers(ctx context.Context, groupID uint64, opts repository.ChatGroupMemberListOptions) ([]model.ChatGroupMember, int64, error) {
	return nil, 0, nil
}
...
func (m *fakeMessageRepo) CreateBatch(ctx context.Context, messages []*model.ChatMessage) error {
	return nil
}
func (m *fakeMessageRepo) ListByGroup(ctx context.Context, opts repository.ChatMessageListOptions) ([]model.ChatMessage, int64, error) {
	return nil, 0, nil
}
func (m *fakeMessageRepo) Get(ctx context.Context, id uint64) (*model.ChatMessage, error) {
	return nil, repository.ErrNotFound
}
func (m *fakeMessageRepo) MarkDeleted(ctx context.Context, id uint64, deletedBy uint64) error {
	return nil
}
func (m *fakeMessageRepo) ListForModeration(ctx context.Context, opts repository.ChatMessageModerationListOptions) ([]model.ChatMessage, int64, error) {
	return nil, 0, nil
}
func (m *fakeMessageRepo) UpdateAuditStatus(ctx context.Context, id uint64, status model.ChatMessageAuditStatus, moderatorID *uint64, reason string) error {
	return nil
}
