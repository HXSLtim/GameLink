...
func (r *permissionRepository) ListByGroup(ctx context.Context, group string) ([]model.Permission, error) {
	var permissions []model.Permission
...
func (r *permissionRepository) GetByMethodAndPath(ctx context.Context, method model.HTTPMethod, path string) (*model.Permission, error) {
	var permission model.Permission
	err := r.db.WithContext(ctx).
