...
func (r *PaymentRepository) List(ctx context.Context, opts repository.PaymentListOptions) ([]model.Payment, int64, error) {
...
func (r *PaymentRepository) Get(ctx context.Context, id uint64) (*model.Payment, error) {
