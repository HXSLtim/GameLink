...
func (r *foRepo) Create(ctx context.Context, o *model.Order) error { if o.ID==0 { o.ID=uint64(len(r.m)+1) } ; r.m[o.ID]=o; return nil }
func (r *foRepo) List(ctx context.Context, opts repository.OrderListOptions) ([]model.Order, int64, error) { out:=[]model.Order{}; for _, v:= range r.m { out = append(out, *v) } ; return out, int64(len(out)), nil }
func (r *foRepo) Get(ctx context.Context, id uint64) (*model.Order, error) { v:=r.m[id]; if v==nil { return nil, repository.ErrNotFound } ; return v, nil }
...
func (r *fpRepo) Create(ctx context.Context, p *model.Payment) error { if p.ID==0 { p.ID=uint64(len(r.m)+1) } ; r.m[p.ID]=p; return nil }
func (r *fpRepo) List(ctx context.Context, opts repository.PaymentListOptions) ([]model.Payment, int64, error) { out:=[]model.Payment{}; for _, v:= range r.m { if opts.OrderID!=nil && v.OrderID==*opts.OrderID { out = append(out, *v) } } ; return out, int64(len(out)), nil }
func (r *fpRepo) Get(ctx context.Context, id uint64) (*model.Payment, error) { v:=r.m[id]; if v==nil { return nil, repository.ErrNotFound } ; return v, nil }
...
func (fuRepo) ListWithFilters(context.Context, repository.UserListOptions) ([]model.User, int64, error) { return nil, 0, nil }
func (fuRepo) Get(context.Context, uint64) (*model.User, error) { return &model.User{Base: model.Base{ID:1}, Name:"u", Role:model.RoleUser, Status:model.UserStatusActive}, nil }
func (fuRepo) GetByPhone(context.Context, string) (*model.User, error) { return nil, repository.ErrNotFound }
func (fuRepo) FindByEmail(context.Context, string) (*model.User, error) { return nil, repository.ErrNotFound }
func (fuRepo) FindByPhone(context.Context, string) (*model.User, error) { return nil, repository.ErrNotFound }
...
func (frRole) ListPaged(context.Context, int, int) ([]model.RoleModel, int64, error) { return nil, 0, nil }
func (frRole) ListPagedWithFilter(context.Context, int, int, string, *bool) ([]model.RoleModel, int64, error) { return nil, 0, nil }
func (frRole) ListWithPermissions(context.Context) ([]model.RoleModel, error) { return nil, nil }
func (frRole) Get(context.Context, uint64) (*model.RoleModel, error) { return nil, repository.ErrNotFound }
func (frRole) GetWithPermissions(context.Context, uint64) (*model.RoleModel, error) { return nil, repository.ErrNotFound }
func (frRole) GetBySlug(context.Context, string) (*model.RoleModel, error) { return &model.RoleModel{Base: model.Base{ID:2}}, nil }
...
func (opLogsStub) ListByEntity(ctx context.Context, entityType string, entityID uint64, opts repository.OperationLogListOptions) ([]model.OperationLog, int64, error) { return nil, 0, nil }

type tagsStub struct{}
func (tagsStub) GetTags(ctx context.Context, playerID uint64) ([]string, error) { return []string{"a"}, nil }
...
func TestAdminService_GetOrderRefunds_Summary(t *testing.T) {
    ...
    if err != nil { t.Fatalf("%v", err) }
    if len(items) == 0 { t.Fatalf("no items") }
}
