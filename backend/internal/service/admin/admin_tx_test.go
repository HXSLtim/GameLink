...
func (p *txPlayers) ListPaged(ctx context.Context, page, pageSize int) ([]model.Player, int64, error) {
	_ = ctx
	_ = page
	_ = pageSize
	return nil, 0, nil
}
func (p *txPlayers) Get(ctx context.Context, id uint64) (*model.Player, error) {
	_ = ctx
	p.gotID = id
	return &model.Player{UserID: 1, Nickname: "p"}, nil
}
func (p *txPlayers) GetByUserID(ctx context.Context, userID uint64) (*model.Player, error) {
	_ = ctx
	return &model.Player{UserID: userID, Nickname: "p"}, nil
}
func (p *txPlayers) Create(ctx context.Context, pl *model.Player) error {
	_ = ctx
	pl.ID = 2
	return nil
}
...
func (u *txUsers) ListPaged(ctx context.Context, page, pageSize int) ([]model.User, int64, error) {
	_ = ctx
	_ = page
	_ = pageSize
	return nil, 0, nil
}
func (u *txUsers) ListWithFilters(ctx context.Context, _ repository.UserListOptions) ([]model.User, int64, error) {
	_ = ctx
	return nil, 0, nil
}
func (u *txUsers) Get(ctx context.Context, _ uint64) (*model.User, error) {
	_ = ctx
	return &model.User{Name: "u"}, nil
}
func (u *txUsers) GetByPhone(ctx context.Context, _ string) (*model.User, error) {
	_ = ctx
	return nil, repository.ErrNotFound
}
func (u *txUsers) FindByEmail(ctx context.Context, _ string) (*model.User, error) {
	_ = ctx
	return nil, repository.ErrNotFound
}
func (u *txUsers) FindByPhone(ctx context.Context, _ string) (*model.User, error) {
	_ = ctx
	return nil, repository.ErrNotFound
}
func (u *txUsers) Create(ctx context.Context, user *model.User) error {
	_ = ctx
	user.ID = 1
	return nil
}
...
func (t *txTags) ReplaceTags(ctx context.Context, _ uint64, tags []string) error {
	_ = ctx
	t.last = tags
	return nil
}
...
func (o *txOpLogs) Append(ctx context.Context, log *model.OperationLog) error {
	_ = ctx
	_ = log
	return nil
}
...
func (t *txTagsErr) GetTags(ctx context.Context, _ uint64) ([]string, error) {
	_ = ctx
	return nil, nil
}
func (t *txTagsErr) ReplaceTags(ctx context.Context, _ uint64, _ []string) error {
	_ = ctx
...
func (f *fakeTx) WithTx(ctx context.Context, fn func(r *common.Repos) error) error {
	_ = ctx
	return fn(&f.repos)
}
...
func TestRegisterUserAndPlayer_Success(t *testing.T) {
	...
	if user == nil || player == nil {
		t.Fatal("expected user and player")
	}
}
