...
func (r *usersRepo) ListPaged(ctx context.Context, page, pageSize int) ([]model.User, int64, error) {
	_ = ctx
	_ = page
	_ = pageSize
	return nil, 0, nil
}
func (r *usersRepo) ListWithFilters(ctx context.Context, opts repository.UserListOptions) ([]model.User, int64, error) {
	_ = ctx
	_ = opts
	return nil, 0, nil
}
func (r *usersRepo) Get(ctx context.Context, _ uint64) (*model.User, error) { _ = ctx; return r.u, nil }
func (r *usersRepo) GetByPhone(ctx context.Context, _ string) (*model.User, error) {
	_ = ctx
	return nil, repository.ErrNotFound
}
func (r *usersRepo) FindByEmail(ctx context.Context, _ string) (*model.User, error) {
	_ = ctx
	return nil, repository.ErrNotFound
}
func (r *usersRepo) FindByPhone(ctx context.Context, _ string) (*model.User, error) {
	_ = ctx
	return nil, repository.ErrNotFound
}
...
func (r *rolesRepo) ListPaged(ctx context.Context, page, pageSize int) ([]model.RoleModel, int64, error) {
	_ = ctx
	_ = page
	_ = pageSize
	return nil, 0, nil
}
func (r *rolesRepo) ListPagedWithFilter(ctx context.Context, page, pageSize int, keyword string, isSystem *bool) ([]model.RoleModel, int64, error) {
	_ = ctx
	_ = page
	_ = pageSize
	_ = keyword
...
func (r *rolesRepo) ListWithPermissions(ctx context.Context) ([]model.RoleModel, error) {
	_ = ctx
	return nil, nil
}
func (r *rolesRepo) Get(ctx context.Context, _ uint64) (*model.RoleModel, error) {
	_ = ctx
	return nil, repository.ErrNotFound
}
func (r *rolesRepo) GetWithPermissions(ctx context.Context, _ uint64) (*model.RoleModel, error) {
	_ = ctx
	return nil, repository.ErrNotFound
}
func (r *rolesRepo) GetBySlug(ctx context.Context, _ string) (*model.RoleModel, error) {
	_ = ctx
	return &model.RoleModel{Base: model.Base{ID: 10}}, nil
}
...
func (r *rolesRepo) AssignPermissions(ctx context.Context, _ uint64, _ []uint64) error {
	_ = ctx
	return nil
}
func (r *rolesRepo) AddPermissions(ctx context.Context, _ uint64, _ []uint64) error {
	_ = ctx
	return nil
}
func (r *rolesRepo) RemovePermissions(ctx context.Context, _ uint64, _ []uint64) error {
	_ = ctx
	return nil
}
func (r *rolesRepo) AssignToUser(ctx context.Context, _ uint64, roleIDs []uint64) error {
	_ = ctx
	r.gotAssign = roleIDs
	return nil
}
func (r *rolesRepo) RemoveFromUser(ctx context.Context, _ uint64, _ []uint64) error {
	_ = ctx
	return nil
}
func (r *rolesRepo) ListByUserID(ctx context.Context, _ uint64) ([]model.RoleModel, error) {
	_ = ctx
	return nil, nil
}
func (r *rolesRepo) CheckUserHasRole(ctx context.Context, _ uint64, _ string) (bool, error) {
	_ = ctx
	return false, nil
}
...
func (o *opLogsPager) ListByEntity(ctx context.Context, entityType string, entityID uint64, opts repository.OperationLogListOptions) ([]model.OperationLog, int64, error) {
	...
	o.calls++
	if opts.Page == 1 {
		return []model.OperationLog{{Base: model.Base{ID: 1}}}, 201, nil
	}
...
func (t *txPager) WithTx(ctx context.Context, fn func(r *common.Repos) error) error {
	_ = ctx
	return fn(&t.repos)
}
...
func TestUpdateUserStatus_And_Role(t *testing.T) {
	...
	if err1 != nil || out1.Status != model.UserStatusSuspended {
		t.Fatalf("status update failed: %v", err1)
	}
	out2, err2 := svc.UpdateUserRole(context.Background(), 1, model.RoleAdmin)
	if err2 != nil || out2.Role != model.RoleAdmin {
		t.Fatalf("role update failed: %v", err2)
	}
	if len(r.gotAssign) != 1 || r.gotAssign[0] != 10 {
		t.Fatalf("expected assign role id 10, got %v", r.gotAssign)
	}
}
...
func TestCollectOperationLogs_AggregatesPages(t *testing.T) {
	...
	if err != nil || len(items) < 1 {
		t.Fatalf("unexpected: err=%v items=%d", err, len(items))
	}
}

type recordOpLogs struct{ last *model.OperationLog }

func (r *recordOpLogs) Append(ctx context.Context, log *model.OperationLog) error {
	_ = ctx
	r.last = log
	return nil
}
func (r *recordOpLogs) ListByEntity(context.Context, string, uint64, repository.OperationLogListOptions) ([]model.OperationLog, int64, error) {
	return nil, 0, nil
}
...
func (p paymentsRepoPending) List(context.Context, repository.PaymentListOptions) ([]model.Payment, int64, error) {
	return nil, 0, nil
}
...
func (t *txRecorder) WithTx(ctx context.Context, fn func(r *common.Repos) error) error {
	return fn(&t.repos)
}
...
func TestCapturePayment_AppendsActorAndTradeNo(t *testing.T) {
	...
	if rec.last == nil || rec.last.ActorUserID == nil {
		t.Fatal("expected actor user id in op log")
	}
	if !bytes.Contains(rec.last.MetadataJSON, []byte("trade_no")) {
		t.Fatal("expected trade_no in metadata")
	}
}

func UpdatePaymentCapture(trade string) CapturePaymentInput {
	return CapturePaymentInput{ProviderTradeNo: trade}
}
...
func TestUpdatePayment_AuditNoRequestID(t *testing.T) {
	...
	if rec.last == nil || rec.last.ActorUserID != nil {
		t.Fatal("expected op log without actor user id")
	}
	if !bytes.Contains(rec.last.MetadataJSON, []byte("status")) {
...
func (reviewsRepoTxErr) List(context.Context, repository.ReviewListOptions) ([]model.Review, int64, error) {
	return nil, 0, nil
}
func (reviewsRepoTxErr) Get(context.Context, uint64) (*model.Review, error) {
...
func (txRejectReviews) WithTx(context.Context, func(r *common.Repos) error) error {
...
func (p paymentsRepo) List(ctx context.Context, opts repository.PaymentListOptions) ([]model.Payment, int64, error) {
	_ = ctx
	if opts.Page == 1 {
		return []model.Payment{{Base: model.Base{ID: 1}}}, 201, nil
	}
	if opts.Page == 2 {
		return []model.Payment{{Base: model.Base{ID: 2}}}, 201, nil
	}
	return []model.Payment{}, 201, nil
}
func (p paymentsRepo) Get(context.Context, uint64) (*model.Payment, error) {
	return nil, repository.ErrNotFound
}
...
func (u *usersRepoCount) ListPaged(context.Context, int, int) ([]model.User, int64, error) {
	return nil, 0, nil
}
func (u *usersRepoCount) ListWithFilters(context.Context, repository.UserListOptions) ([]model.User, int64, error) {
	return nil, 0, nil
}
func (u *usersRepoCount) Get(context.Context, uint64) (*model.User, error) {
	u.calls++
	return nil, repository.ErrNotFound
}
func (u *usersRepoCount) GetByPhone(context.Context, string) (*model.User, error) {
	return nil, repository.ErrNotFound
}
func (u *usersRepoCount) FindByEmail(context.Context, string) (*model.User, error) {
	return nil, repository.ErrNotFound
}
func (u *usersRepoCount) FindByPhone(context.Context, string) (*model.User, error) {
	return nil, repository.ErrNotFound
}
...
func TestResolveUser_CachesNotFound(t *testing.T) {
	...
	if r1 != nil || r2 != nil || u.calls != 1 {
		t.Fatalf("expected single repo call and nil user, got calls=%d", u.calls)
	}
}
...
func (t *txErr) WithTx(ctx context.Context, fn func(r *common.Repos) error) error {
	return fn(&t.repos)
}
...
func TestListOperationLogs_ErrorPath(t *testing.T) {
	...
	if err == nil {
		t.Fatal("expected error from OpLogs.ListByEntity")
	}
}
...
func TestListOperationLogs_NoTx(t *testing.T) {
	...
	_, _, err := svc.ListOperationLogs(context.Background(), "order", 1, repository.OperationLogListOptions{Page: 1, PageSize: 10})
	if err == nil {
		t.Fatal("expected transaction manager not configured")
	}
}
...
func (p paymentsRepoGet) List(context.Context, repository.PaymentListOptions) ([]model.Payment, int64, error) {
	return nil, 0, nil
}
...
func (playersRepoAssign) ListPaged(context.Context, int, int) ([]model.Player, int64, error) {
	return nil, 0, nil
}
func (playersRepoAssign) Get(context.Context, uint64) (*model.Player, error) {
	return &model.Player{Nickname: "p"}, nil
}
func (playersRepoAssign) GetByUserID(context.Context, uint64) (*model.Player, error) {
	return &model.Player{Nickname: "p"}, nil
}
...
func (o ordersRepoAssign) List(context.Context, repository.OrderListOptions) ([]model.Order, int64, error) {
	return nil, 0, nil
}
func (o ordersRepoAssign) Get(context.Context, uint64) (*model.Order, error) {
	return &model.Order{Status: o.status}, nil
}
...
func TestAssignOrder_Validations(t *testing.T) {
	...
	if _, err := svc.AssignOrder(context.Background(), 1, 0); err == nil {
		t.Fatal("expected validation error for zero playerID")
	}
	if _, err := svc.AssignOrder(context.Background(), 1, 2); err == nil {
		t.Fatal("expected validation error for completed order")
	}
}
