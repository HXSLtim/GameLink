...
import { Loader2, Gamepad2, Mail, Smartphone } from "lucide-react"
    ...
    return (
        <div className="w-full h-screen min-h-[600px] lg:grid lg:grid-cols-2 relative transition-colors duration-300">
            ...
            <div className="hidden lg:flex flex-col relative bg-muted text-white dark:border-r overflow-hidden">
                ...
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=2671&auto=format&fit=crop')] bg-cover bg-center opacity-10 mix-blend-overlay" />
                ...
                <div className="relative z-20 mt-auto p-10 space-y-4">
                    <blockquote className="space-y-2">
                        <p className="text-xl font-semibold leading-relaxed">
                            {t('auth.join_community_slogan', { defaultValue: "Join the ultimate gaming community. Play, compete, and connect." })}
                        </p>
                    </blockquote>
                </div>
            </div>
                ...
                <div className="mx-auto grid w-full max-w-[380px] gap-6">
                    <div className="flex flex-col space-y-2 text-center">
                        ...
                        <p className="text-sm text-muted-foreground">
                            {t('auth.enter_details_signup', { defaultValue: "Enter your details below to create your account" })}
                        </p>
                    </div>
                        ...
                        <Tabs defaultValue="email" value={regMethod} onValueChange={(v) => setRegMethod(v as 'email' | 'phone')} className="w-full">
                            ...
                            <div className="space-y-4">
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        id="nickname"
                                        placeholder={t('auth.nickname_placeholder', { defaultValue: "Display Name" })}
                                        type="text"
                                        value={nickname}
                    ...
                    <Button variant="outline" type="button" disabled={loading} className="w-full" onClick={() => navigate('/login')}>
                        {t('auth.already_have_account_login', { defaultValue: "Already have an account? Sign in" })}
                    </Button>
