        ...
        return (
            <PageContainer>
                <div className="flex flex-col items-center justify-center h-full space-y-4 animate-in fade-in">
                    <p className="text-muted-foreground">{t('chat.not_found')}</p>
                    <Button variant="outline" onClick={() => navigate('/chat')}>{t('chat.back')}</Button>
                </div>
            </PageContainer>
        );
    }
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span className="text-xs text-muted-foreground flex items-center gap-1.5 mt-1">
                            {conversation?.online ? t('nav.status.online') : t('nav.status.offline')}
            ...
            <div className="flex-1 overflow-hidden flex flex-col bg-background/30 relative">
                ...
                <ScrollArea className="flex-1 p-4">
                    <div className="space-y-6 px-2 pb-4 w-full pt-4">
                        ...
                        {loading && <div className="text-center text-xs text-muted-foreground py-4 animate-pulse">{t('chat.updating')}</div>}
                    </div>
                </ScrollArea>
