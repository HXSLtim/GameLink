                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                    ...
                    <div className="md:col-span-2 space-y-8">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="flex gap-4 p-4 rounded-xl bg-muted/30 border border-white/5">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground mt-1">Great player, very friendly and skilled! learned a lot.</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
